...
impl SchwabAdapter {
    pub fn new() -> Self {
        let (api_key, secret, redirect) = env::load_schwab_config();
        Self { _api_key: api_key, _secret: secret, _redirect: redirect }
    }
}

impl BrokerAdapter for SchwabAdapter {
